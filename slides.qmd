...
-   **Sensitivity**: Focus on high-quality wine detection
...
![](images/clipboard-1482690385.png)

-   Alcohol content increases with wine quality
-   Trend is clear in both red and white wines

Confirms model’s selection of alcohol as top predictor.

## Boxplot: Volatile Acidity vs Quality

![](images/clipboard-25951971.png)

-   Higher VA in lower quality wines
-   Decreasing trend most apparent in red wine

Matches correlation and importance findings.
